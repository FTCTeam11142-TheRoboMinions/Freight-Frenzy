...
@Autonomous
public class CVDetection extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if ((pipeline.region1Avg() > pipeline.region2Avg()) && (pipeline.region1Avg() > pipeline.region3Avg())) telemetry.addLine("Top");
            if ((pipeline.region2Avg() > pipeline.region1Avg()) && (pipeline.region2Avg() > pipeline.region3Avg())) telemetry.addLine("Middle");
            if ((pipeline.region3Avg() > pipeline.region1Avg()) && (pipeline.region3Avg() > pipeline.region2Avg())) telemetry.addLine("Bottom");
